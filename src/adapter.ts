...
import utils = require('axios/lib/utils');
import settle = require('axios/lib/core/settle');
import buildURL = require('axios/lib/helpers/buildURL');
import http = require('http');
import https = require('https');
import url = require('url');
import zlib = require('zlib');
import createError = require('axios/lib/core/createError');
import enhanceError = require('axios/lib/core/enhanceError');
...
export = function httpAdapter(config) {
  return new Promise(function dispatchHttpRequest(resolvePromise, rejectPromise) {
    ...
    // Create the request
    var res = transport.request(options.method, options);
